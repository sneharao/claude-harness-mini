...
- Before finalizing your critique, check the available MCP servers for documentation tools (e.g. library docs) that could help verify assumptions or surface relevant details during the review
