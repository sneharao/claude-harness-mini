...
- **During apply-fixes (004):** A human PR comment amounts to "you should have known X" — the agent made an error a better skill, rule, or knowledge file would have prevented.
